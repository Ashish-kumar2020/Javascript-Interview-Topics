# 11 - SetTimeout + Closures Interview
...
setTimeout takes this callback function & attaches timer of 3000ms and stores it.
...
When setTimeout stores the function somewhere and attaches timer to it, the function remembers its reference to i, not value of i.
...
And due to looping, the i value became 6.

And when the callback fun runs the variable i = 6.
